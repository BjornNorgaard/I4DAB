...
\begin{figure}[H]
\centering
\includegraphics[width=\linewidth]{figs/spm1/modelTypes.PNG}
\caption{De 3 typer af Data Models.}
\label{fig:modelTypes}
\end{figure}


Ud fra dette skema kan den fysiske database genereres.
...
En primær nøgle kan unikt identificere hver række/record i en database tabel. PK'er \textbf{skal} indeholde værider og kan derfor ikke være NULL.

En tabel kan kun have 1 primær nøgle, som kan bestå af enkelte eller flere felter. Når der bruges flere felter kaldes nøglen en composite key.

\paragraph{Sekundærnøgle}
En Fremmednøgle er en attribut eller samling af attributter i en tabel, der unikt identificerer en række i en anden tabel.

Sagt simpelt, er Fremmednøglen defineret i en anden tabel, men den referere til primærnøglen i den første tabel.
