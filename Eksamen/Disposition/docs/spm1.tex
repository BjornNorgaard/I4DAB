...
Ud fra dette skema den fysiske database genereres.\todo{hvilket skema?}
...
\paragraph{Multiplicity} \todo{figure out}
...
\paragraph{Kardinalitet}\todo{figure out}
...
\subsubsection{Keys}\todo{sæt ind!}
