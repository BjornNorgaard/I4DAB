...
\input{docs/spm6/terminology}
\input{docs/spm6/setoperations}
\input{docs/spm6/select}
\input{docs/spm6/project}
\input{docs/spm6/select_and_project}
\input{docs/spm6/cartesian_product}
