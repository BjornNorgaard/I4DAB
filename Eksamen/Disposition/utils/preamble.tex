...
\lstset{
	...
	otherkeywords={Node, Graph, NULL, pthread_t, pthread_create, pthread_join,SELECT,FROM,WHERE,ORDER,BY,AVG,SET,INSERT,MERGE,DELETE,WHEN,ON,USING,VALUES,NOT,MATCHED,THEN,UPDATE,JOIN,INTO}, 	% til keywords 
